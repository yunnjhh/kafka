package com.fastcampus.springkafka.Ch01.Clip03.producer;
...
public class ClipProducer {
    ...
    public void sync(String topic, String message) {
        ...
        try {
            ...
            future.get(10, TimeUnit.SECONDS); // 동기 처리
    ...
    public void replyingSend(String topic, String message) throws ExecutionException, InterruptedException, TimeoutException {
        ...
        System.out.println("===> " + consumerRecord.value() + ", " +consumerRecord.topic()); // 발행한 메세지 확인 가능

        // 따로 clip3-replies 의 컨슈머를 만들지 않아도, 컨슈머의 레코드를 뽑아내서 볼 수 있게 만들어짐.
    }
